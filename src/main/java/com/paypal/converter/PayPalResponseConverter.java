...
public abstract class PayPalResponseConverter {

    public abstract PayPalPayment convert(Payment payment);

    void populateResponse(Payment payment, PayPalPayment paymentResponse) {
    ...
    private List<com.paypal.model.Error> getErrors(Payment payment) {
